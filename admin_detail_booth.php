...
if (!$_SESSION["UserID"]){  //check session
  ...
  <head>
    ...
    <title>ADMIN | รายละเอียดข้อมูลบุธ</title>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" data-background-color="red">
                                            <h4 class="title">รายละเอียดข้อมูลบูธ</h4>
...
//ถ้ามีการส่งค่าข้อมูล
                                         ...
                                         $dsql = "SELECT * FROM `booths` WHERE booth_id = '".$id."' ";
                                       

                                           $dquery = mysqli_query($con,$dsql);

                                           $result = mysqli_fetch_array($dquery,MYSQLI_ASSOC); ?>
                                           <tr>
                                        ...
                                        ?>
                                             <center>
                                                ...
                                                <a href="event_index.php" class='btn btn-primary'>ย้อนกลับ</a> 
